    ...
    <div className="quiz-screen">
      <header className="quiz-header">
        <div className="q-counter">
          ...
          <span className="quiz-label">Quiz 2</span>
...
function Lobby({ onStart }: { onStart: () => void }) {
  return (
    <div className="lobby">
      ...
      <div className="quiz-number-badge">Quiz 2</div>
      <h1 className="lobby-title">GitOps Principles</h1>
      <p className="lobby-sub">ArgoCD Series · Declarative State, Pull Model &amp; Self-Healing</p>
      <div className="badge-row">
        <span className="badge">Declarative</span>
        <span className="badge">Pull Model</span>
        <span className="badge">Immutability</span>
